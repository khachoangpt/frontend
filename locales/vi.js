...
const vi = {
  ...
  sidebar: {
    ...
    expand: 'Mở rộng',
    logout: 'Đăng xuất',
    workingPolicy: 'Chính sách làm việc',
    welfare: 'Phúc lợi',
    tax: 'Thuế',
    insurance: 'Bảo hiểm',
    paidLeave: 'Nghỉ phép',
  ...
  salary: {
    payrollAccounting: 'Quản lý tiền lương',
    employeeName: 'Tên nhân viên',
    status: 'Trạng thái',
    myPayroll: 'Bảng lương của tôi',
    employeePayroll: 'Bảng lương của nhân viên',
    month: 'Tháng',
    position: 'Vị trí',
    standardWorkingDay: 'Ngày công tiêu chuẩn',
    actualWorkingDay: 'Giờ làm thực tế',
    otPoint: 'Điểm OT',
    deduction: 'Deduction',
    insurance: 'Bảo hiểm',
    tax: 'Thuế',
  ...
  synthetic: {
    syntheticHeader: 'Tổng hợp biểu đồ quản lý nhân viên phòng ban',
    totalEmployee: 'Tổng số nhân viên phòng ban',
    age: 'Độ tuổi',
    seniority: 'Thâm niên',
    reasonLeave: 'Thống kê nghỉ việc theo năm',
    reasonOnLeave: 'Thống kê nghỉ phép theo năm',
    male: 'Nam',
    female: 'Nữ',
  },
